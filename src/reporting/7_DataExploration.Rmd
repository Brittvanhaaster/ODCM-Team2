...
Most of the observations within the dataset correspond to the standby queues, with over 6,000 recorded entries. The single-rider queues are less represented with less than 2,000 recorded entries. The live queue data primarily captured the standard queue behavior.
